                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    <a data-href="{{ route("dashboard.comments.show", $comment->id) }}" class="btn btn-primary btn-sm commentdetails">Details</a>
                                                    <form id="del-{{ $comment->id }}"
                                                        action="{{ route('dashboard.comments.destroy', $comment->id) }}"
                                                        method="POST"
                                                        class="d-inline"
                                                        onsubmit="return confirm('Yakin hapus comment ini?');">
                                                    @csrf
                                                    @method('DELETE')
